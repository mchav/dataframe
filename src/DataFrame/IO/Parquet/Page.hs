...
readPageTypeHeader INDEX_PAGE_HEADER _ _  = error "Index page header not supported"
readPageTypeHeader PAGE_TYPE_HEADER_UNKNOWN _ _  = error "Unknown page type header"
